...
const navigate = useNavigate();
 ...
 const [showOutOverlay, setShowOutOverLay] = useState(false);
  ...
  useEffect(() => {
    // Slide away after 1.2s
    const timer = setTimeout(() => setShowOverlay(false), 1);
  ...
  return (
      ...
      <div
        className={`fixed top-0 left-0 w-full h-full bg-[#cca7ab] z-50 transition-transform duration-700 ease-in-out ${
          showOutOverlay ? "translate-x-0" : "-translate-x-full"
        }`}
      ></div>
      <div
        className={`fixed top-0 left-0 w-full h-full bg-[#cca7ab] z-50 transition-transform duration-700 ease-in-out ${
      ...
      <div className="relative container grid grid-cols-12 pb-24 md:pb-28 pt-36 md:pt-40 vacanciesBg h-[100vh] pl-[56px]">
        <div className="md:col-start-2 xl:col-start-1 col-span-12 md:col-span-8 xl:col-span-4">
          <div className="xl:flex">
            <Link to="/" onClick={handleHomeClick} className="fairy-cursor-overlay">
              <div className="pr-3 block mb-4 xl:mb-0">
                <div className="svg-box opacity-20 py-1 transition-all duration-500 hover:-translate-x-2">
                  <svg
                    width="32"
                    height="12"
                    viewBox="0 0 32 12"
            ...
            <div>
              <a href="/" className="fairy-cursor-overlay text-dark">
                <h1 className="dm-sans md:!text-[16px] !text-[14px] mb-5">Our vacancies</h1>
              </a>
              <p className="playFair xl:text-[4.3rem] lg:text-[3.5rem] md:text-[2.8rem] text-[1.7rem] xl:leading-14 lg:leading-12 md:leading-10 leading-8">Create narratives that last Forever.</p>
            </div>
          </div>
        </div>
        <div className="md:col-start-2 xl:col-start-6 col-span-11 md:col-span-10 xl:col-span-8 mt-8 xl:mt-0">
         
          <div className="grid grid-cols-12 items-center">
            <div className="col-span-12 md:col-span-8">
              <p className="mb-4 dm-sans md:!text-[16px] !text-[14px]">Open letter</p>
              <p className="mb-0 md:!text-[16px] !text-[14px]">
                Everybody has a story to tell, but maybe you’re still looking
                for the right place to tell yours. In that case, feel free to
                send us an open letter.
              </p>
            </div>
            <div className="col-span-12 mt-5">
              <a
                className="askAnything askAnythingUnderline md:!text-[16px] !text-[14px] "
         ...
         <div class="absolute bottom-10 left-0 px-[56px] col-span-12 mt-50 grid grid-cols-12 w-full items-center">
          ...
          <div className="flex xl:col-span-2 col-span-1 svg-container justify-center ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
             
              viewBox="0 0 16 16"
              className=" h-[40px] xl:block hidden"
            >
              <g
                fill="none"
                stroke="black"
